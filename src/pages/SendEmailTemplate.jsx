...
const SendEmailTemplate = () => {
  ...
  const callTestEmailTemplates = async () => {
    ...
    const { subject, description, whereUsed, emailName } = emailTemplateDetails;
  ...
  return (
    <div className="main-body-section">
      <div className="heading-part px-7 py-4 border-b">
        <h4 className="small-title font-bold theme-color">Email Template</h4>
      </div>

      <div className="email-tester-wrapper">
        <div className="email-tester-form">
          <div className="email-tester-field">
            <h2 className="input-label">Email To</h2>
            <input
              type="text"
              name="emailName"
          ...
          <div className="email-tester-field">
            <h2 className="input-label">Email Subject</h2>
            <input
              type="text"
              name="subject"
          ...
          <div className="email-tester-field">
            <h2 className="input-label">Email CC</h2>
            <input
              type="text"
              name="whereUsed"
        ...
        <div className="flex justify-between mt-12 pb-8">
          <button className="btn" onClick={() => setRedirect("/")}>
            Back
          </button>
